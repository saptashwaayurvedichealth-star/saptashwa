      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  ...
                  <p className="text-3xl font-bold text-gray-800">
                    <AnimatedCounter end={13} duration={2.5} suffix="+" />
                  </p>
                ...
                >
                  ...
                  <p className="text-3xl font-bold text-gray-800">
                    <AnimatedCounter end={2016} duration={2.5} />
                  </p>
          ...
          >
            ...
            >
              Dr. Sudha is the Managing Director of Saptashwa Ayurvedic Health Center, Rajarajeshwari Nagar, Bengaluru, 
              which was established in 2016. With more than 13 years of dedicated experience in the field of Ayurveda, 
              she has successfully treated and guided over 5000 patients towards holistic health and wellbeing.
            </motion.p>
            ...
            >
              She has completed her postgraduation in Shalakya Tantra, the specialized branch of Ayurveda that deals 
              with diseases of the eyes, ears, nose, throat, head, and neck. Her expertise in Shalakya Tantra, combined 
              with her proficiency in Panchakarma therapies, enables her to provide comprehensive and precise Ayurvedic 
            ...
            >
              {[
                'Postgraduate in Shalakya Tantra',
